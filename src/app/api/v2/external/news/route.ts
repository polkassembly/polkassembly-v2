...
import { NEWS_GOOGLE_SHEET_ID, NEWS_GOOGLE_SHEET_NAME, GOOGLE_API_KEY } from '@/app/api/_api-constants/apiEnvVars';
import { withErrorHandling } from '@/app/api/_api-utils/withErrorHandling';
import { GoogleSheetService } from '../../../_api-services/external_api_service/googlesheets_service';

export const GET = withErrorHandling(async () => {
	if (!GOOGLE_API_KEY || !NEWS_GOOGLE_SHEET_ID || !NEWS_GOOGLE_SHEET_NAME) {
