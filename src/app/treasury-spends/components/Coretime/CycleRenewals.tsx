...
function CycleRenewals({ cycleId }: { cycleId: string }) {
					...
					<Table>
						<TableHeader>
							<TableRow className={`${styles.headerRow} border-t border-border_grey uppercase`}>
								...
								<TableHead className={styles.headerCell}>OLD CORE</TableHead>
								...
								return (
									<React.Fragment key={allocation?.id}>
										<TableRow>
											...
											<TableCell className='px-6 py-3'>{allocation.oldCore}</TableCell>
