...
import { TableRow, TableCell } from '../../../_shared-components/Table';
...
import SwitchWalletOrAddress from '../../../_shared-components/SwitchWalletOrAddress/SwitchWalletOrAddress';
import AddressRelationsPicker from '../../../_shared-components/AddressRelationsPicker/AddressRelationsPicker';
...
function JudgementRow({ preimage, handleDialogOpen, onUnnotePreimage }: { preimage: IPreimage; handleDialogOpen: () => void; onUnnotePreimage: () => void }) {
