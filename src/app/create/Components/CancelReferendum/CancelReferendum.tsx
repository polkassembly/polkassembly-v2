...
function CancelReferendum({ onProposalCreationSuccess }: { onProposalCreationSuccess: (proposalId: number) => void }) {
	...
	const tx = useMemo(() => {
		...
		return apiService.getCancelReferendumExtrinsic({ referendumId: data.index });
	}, [apiService, data]);
