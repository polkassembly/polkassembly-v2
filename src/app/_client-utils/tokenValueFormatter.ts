...
export const getFormattedValue = (value: string, network: ENetwork, currentTokenPrice: number): string => {
...
export const formatTokenValue = (value: string, network: ENetwork, tokenPrice: number, unit?: string): string => {
