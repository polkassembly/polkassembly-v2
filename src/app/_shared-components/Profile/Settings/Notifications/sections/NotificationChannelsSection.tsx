...
import NotificationChannelsIcon from '@assets/icons/notificationchannel.svg';
					...
					<div className={classes.collapsibleContent}>
						<div className='flex flex-col'>
							...
							<EmailNotificationCard
								...
								notificationEnabled={channelPreferences?.[ENotificationChannel.EMAIL]?.enabled || false}
