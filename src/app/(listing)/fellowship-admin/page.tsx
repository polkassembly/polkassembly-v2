...
export async function generateMetadata(): Promise<Metadata> {
	...
	return getGeneratedContentMetadata({
		title: `${title} - Fellowship Admin Proposals`,
		description: 'Explore all Fellowship Admin proposals on Polkassembly',
		url: `https://${network}.polkassembly.io/fellowship-admin`,
		imageAlt: 'Polkassembly Fellowship Admin Proposals',
		network
	});
}

const origin = EPostOrigin.FELLOWSHIP_ADMIN;
...
async function FellowshipAdminPage({ searchParams }: { searchParams: Promise<{ page?: string; status?: string }> }) {
