...
async function ReferendumKillerPage({ searchParams }: { searchParams: Promise<{ page?: string; trackStatus?: string }> }) {
	...
	const { data, error } = await NextApiClientService.fetchListingDataApi(EProposalType.REFERENDUM_V2, page, statuses, [EPostOrigin.REFERENDUM_KILLER], []);
	...
	return (
		<div>
			<ListingPage
				...
				description='View all Referendum Killer proposals on Polkassembly'
