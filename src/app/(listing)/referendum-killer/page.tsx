...
const origin = EPostOrigin.REFERENDUM_KILLER;
...
export async function generateMetadata(): Promise<Metadata> {
	...
	return getGeneratedContentMetadata({
		title: `${title} - Referendum Killer Proposals`,
		description: 'Explore all Referendum Killer Proposals on Polkassembly',
		url: `https://${network}.polkassembly.io/referendum-killer`,
		imageAlt: 'Polkassembly Referendum Killer Proposals',
		network
	});
}
...
async function ReferendumKillerPage({ searchParams }: { searchParams: Promise<{ page?: string; status?: string }> }) {
...
export default ReferendumKillerPage;
