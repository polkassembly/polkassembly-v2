...
async function TreasuryProposalsPage({ searchParams }: { searchParams: Promise<{ page?: string; trackStatus?: string }> }) {
	...
	const { data, error } = await NextApiClientService.fetchListingData({ proposalType: EProposalType.TREASURY_PROPOSAL, page, statuses });
	...
	return (
		<div>
			<ListingPage
				proposalType={EProposalType.TREASURY_PROPOSAL}
