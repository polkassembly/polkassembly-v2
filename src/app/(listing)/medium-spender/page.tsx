...
const origin = EPostOrigin.MEDIUM_SPENDER;
...
export async function generateMetadata(): Promise<Metadata> {
	...
	return getGeneratedContentMetadata({
		title: `${title} - Medium Spender Proposals`,
		description: 'Explore all Medium Spender proposals on Polkassembly',
		url: `https://${network}.polkassembly.io/medium-spender`,
		imageAlt: 'Polkassembly Medium Spender Proposals',
		network
	});
}
...
async function MediumSpenderPage({ searchParams }: { searchParams: Promise<{ page?: string; status?: string }> }) {
...
export default MediumSpenderPage;
