...
const origin = EPostOrigin.REFERENDUM_CANCELLER;
...
export async function generateMetadata(): Promise<Metadata> {
	...
	return getGeneratedContentMetadata({
		title: `${title} - Referendum Canceller Proposals`,
		description: 'Explore all Referendum Canceller Proposals on Polkassembly',
		url: `https://${network}.polkassembly.io/referendum-canceller`,
		imageAlt: 'Polkassembly Referendum Canceller Proposals',
		network
	});
}
...
async function ReferendumCancellerPage({ searchParams }: { searchParams: Promise<{ page?: string; status?: string }> }) {
