...
async function DiscussionsPage({ searchParams }: { searchParams: Promise<{ page?: string; trackStatus?: string }> }) {
	...
	const { data, error } = await NextApiClientService.fetchListingData(EProposalType.DISCUSSION, page, statuses, [], []);
