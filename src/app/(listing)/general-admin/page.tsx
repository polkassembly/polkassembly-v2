...
export async function generateMetadata(): Promise<Metadata> {
	...
	return getGeneratedContentMetadata({
		title: `${title} - General Admin Proposals`,
		description: 'Explore all General Admin proposals on Polkassembly',
		url: `https://${network}.polkassembly.io/general-admin`,
		imageAlt: 'Polkassembly General Admin Proposals',
		network
	});
}

const origin = EPostOrigin.GENERAL_ADMIN;
...
async function GeneralAdminPage({ searchParams }: { searchParams: Promise<{ page?: string; status?: string }> }) {
