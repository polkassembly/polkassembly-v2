...
async function MembersPage({ searchParams }: { searchParams: Promise<{ page?: string; trackStatus?: string }> }) {
	...
	const { data, error } = await NextApiClientService.fetchListingDataApi(EProposalType.REFERENDUM_V2, page, statuses, [EPostOrigin.MEMBERS], []);
	...
	return (
		<div>
			<ListingPage
				title='Members'
				description='View and participate in member referenda'
