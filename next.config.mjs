...
export const ALLOWED_OUTBOUND_IFRAME_DOMAINS = ['https://*.bmcdn6.com', 'https://app.mimir.global'];
		...
		return [
			{
				...
				headers: [
					...
					{ key: 'Permissions-Policy', value: 'camera=self, microphone=(), geolocation=self' },
					{
						...
						value: [
							"default-src 'self'",
							"script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.bmcdn6.com https://www.googletagmanager.com https://www.google-analytics.com https://js.sentry-cdn.com",
							...
							"base-uri 'self'",
							"form-action 'self'",
							"connect-src 'self' https://*.google-analytics.com https://*.bmcdn6.com https://api.github.com https://*.polkassembly.io https://*.polkassembly.network https://*.firebaseapp.com https://*.googleapis.com https://sentry.io https://o4504609384013824.ingest.sentry.io wss: https://www.google-analytics.com https://*.algolia.net https://*.algolianet.com https://*.algolia.io https://api.imgbb.com https://www.googletagmanager.com",
